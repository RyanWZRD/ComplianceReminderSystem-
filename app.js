...
import {
  EMAIL_AUTOMATION_DELIVERY_LOG_COLUMNS,
  EMAIL_AUTOMATION_RUN_COLUMNS,
  EMAIL_AUTOMATION_DELIVERY_LOG_EMPTY_MESSAGE,
  EMAIL_AUTOMATION_VISIBILITY_EMPTY_MESSAGE,
  mapAutomationRunToVisibilityRow,
  mapDeliveryLogsToVisibilityRows,
  shortenDisplayId,
} from "./js/app/automation/email-automation-visibility-ui.js";
import { loadAutomationRuns } from "./js/app/cloud/automation-runs.js";
import { loadDeliveryLogs } from "./js/app/cloud/delivery-logs.js";
...
import {
  ...
  REMINDER_DIGEST_COPY_SUCCESS_MESSAGE,
  REMINDER_DIGEST_COPY_UNAVAILABLE_MESSAGE,
...
import {
  ...
  getReminderQueueTemplatePreviewRowKey,
...
const reminderPreviewDashboard30Count = document.getElementById(
  "reminder-preview-dashboard-30-count"
);
const reminderPreviewDashboard14Count = document.getElementById(
  "reminder-preview-dashboard-14-count"
);
const reminderPreviewDashboard7Count = document.getElementById(
  "reminder-preview-dashboard-7-count"
);
const reminderPreviewDashboardExpiredCount = document.getElementById(
  "reminder-preview-dashboard-expired-count"
);
const reminderPreviewDashboardTotalCount = document.getElementById(
  "reminder-preview-dashboard-total-count"
);
const reminderPreviewDashboardEmptyHint = document.getElementById(
  "reminder-preview-dashboard-empty-hint"
);
const reminderPreviewDashboardPreview = document.getElementById(
  "reminder-preview-dashboard-preview"
);
const reminderPreviewDashboardPreviewTitle = document.getElementById(
  "reminder-preview-dashboard-preview-title"
);
const reminderPreviewDashboardPreviewMeta = document.getElementById(
  "reminder-preview-dashboard-preview-meta"
);
const reminderPreviewDashboardPreviewDescription = document.getElementById(
  "reminder-preview-dashboard-preview-description"
);
const reminderPreviewDashboardTableHead = document.getElementById(
  "reminder-preview-dashboard-table-head"
);
const reminderPreviewDashboardTableBody = document.getElementById(
  "reminder-preview-dashboard-table-body"
);
const exportReminderPreviewPackBtn = document.getElementById(
  "export-reminder-preview-pack-btn"
);
const clearReminderPreviewDashboardPreviewBtn = document.getElementById(
  "clear-reminder-preview-dashboard-preview-btn"
);
const reminderPreviewDashboardCards = document.querySelectorAll(
  "[data-reminder-preview-dashboard]"
);
const reminderQueuePreviewSection = document.getElementById("reminder-queue-preview-section");
const reminderQueuePreviewTotalCount = document.getElementById("reminder-queue-preview-total-count");
const reminderQueuePreviewMissingEmailCount = document.getElementById(
  "reminder-queue-preview-missing-email-count"
);
const reminderQueuePreviewExpiredCount = document.getElementById(
  "reminder-queue-preview-expired-count"
);
const reminderQueuePreview30Count = document.getElementById("reminder-queue-preview-30-count");
const reminderQueuePreview14Count = document.getElementById("reminder-queue-preview-14-count");
const reminderQueuePreview7Count = document.getElementById("reminder-queue-preview-7-count");
const reminderQueuePreviewMeta = document.getElementById("reminder-queue-preview-meta");
const reminderQueuePreviewEmpty = document.getElementById("reminder-queue-preview-empty");
const reminderQueuePreviewTableWrapper = document.getElementById(
  "reminder-queue-preview-table-wrapper"
);
const reminderQueuePreviewTableHead = document.getElementById("reminder-queue-preview-table-head");
const reminderQueuePreviewTableBody = document.getElementById("reminder-queue-preview-table-body");
const exportReminderQueueCsvBtn = document.getElementById("export-reminder-queue-csv-btn");
const reminderDigestPreview = document.getElementById("reminder-digest-preview");
const reminderDigestPreviewSafetyNote = document.getElementById("reminder-digest-preview-safety-note");
const reminderDigestPreviewTotalCount = document.getElementById("reminder-digest-preview-total-count");
const reminderDigestPreviewMissingEmailCount = document.getElementById(
  "reminder-digest-preview-missing-email-count"
);
const reminderDigestPreviewExpiredCount = document.getElementById("reminder-digest-preview-expired-count");
const reminderDigestPreview30Count = document.getElementById("reminder-digest-preview-30-count");
const reminderDigestPreview14Count = document.getElementById("reminder-digest-preview-14-count");
const reminderDigestPreview7Count = document.getElementById("reminder-digest-preview-7-count");
const reminderDigestPreviewSubject = document.getElementById("reminder-digest-preview-subject");
const reminderDigestPreviewBody = document.getElementById("reminder-digest-preview-body");
const reminderDigestPreviewCopyBtn = document.getElementById("reminder-digest-preview-copy-btn");
const reminderDigestPreviewCopyMessage = document.getElementById("reminder-digest-preview-copy-message");
const automationRunAuditSection = document.getElementById("automation-run-audit-section");
const automationRunAuditLocalHint = document.getElementById("automation-run-audit-local-hint");
const automationRunAuditError = document.getElementById("automation-run-audit-error");
const automationRunAuditEmpty = document.getElementById("automation-run-audit-empty");
...
const emailAutomationVisibilitySection = document.getElementById("email-automation-visibility-section");
const emailAutomationVisibilityLocalHint = document.getElementById(
  "email-automation-visibility-local-hint"
);
const emailAutomationVisibilityError = document.getElementById("email-automation-visibility-error");
const emailAutomationVisibilityEmpty = document.getElementById("email-automation-visibility-empty");
const emailAutomationVisibilityRunsWrapper = document.getElementById(
  "email-automation-visibility-runs-wrapper"
);
const emailAutomationVisibilityRunsHead = document.getElementById(
  "email-automation-visibility-runs-head"
);
const emailAutomationVisibilityRunsBody = document.getElementById(
  "email-automation-visibility-runs-body"
);
const emailAutomationVisibilityLogsPanel = document.getElementById(
  "email-automation-visibility-logs-panel"
);
const emailAutomationVisibilityLogsTitle = document.getElementById(
  "email-automation-visibility-logs-title"
);
const emailAutomationVisibilityLogsError = document.getElementById(
  "email-automation-visibility-logs-error"
);
const emailAutomationVisibilityLogsEmpty = document.getElementById(
  "email-automation-visibility-logs-empty"
);
const emailAutomationVisibilityLogsWrapper = document.getElementById(
  "email-automation-visibility-logs-wrapper"
);
const emailAutomationVisibilityLogsHead = document.getElementById(
  "email-automation-visibility-logs-head"
);
const emailAutomationVisibilityLogsBody = document.getElementById(
...
let currentReminderPreviewDashboard = null;
...
/** @type {"idle" | "loading" | "loaded" | "error" | "local" | "denied"} */
let emailAutomationVisibilityLoadState = "idle";
let emailAutomationVisibilityLoadError = "";
/** @type {"idle" | "loading" | "loaded" | "error"} */
let emailAutomationDeliveryLogsLoadState = "idle";
let emailAutomationDeliveryLogsLoadError = "";
/** @type {import("./js/app/cloud/automation-runs.js").AutomationRunVisibilityView[]} */
let emailAutomationRuns = [];
/** @type {import("./js/app/cloud/delivery-logs.js").DeliveryLogVisibilityView[]} */
let emailAutomationDeliveryLogs = [];
let selectedEmailAutomationRunId = "";
...
const complianceInsightsOperationalSummary = document.getElementById(
  "compliance-insights-operational-summary"
);
const complianceInsightsOperationalScore = document.getElementById(
  "compliance-insights-operational-score"
);
const complianceInsightsOperationalDetail = document.getElementById(
  "compliance-insights-operational-detail"
);
const complianceInsightsOperationalMissingCount = document.getElementById(
  "compliance-insights-operational-missing-count"
);
...
const complianceInsightsEvidenceGapsEmpty = document.getElementById(
  "compliance-insights-evidence-gaps-empty"
);
const complianceInsightsEvidenceGapsStrip = document.getElementById(
  "compliance-insights-evidence-gaps-strip"
);
const complianceInsightsForecastEmpty = document.getElementById(
  "compliance-insights-forecast-empty"
);
const complianceInsightsForecastCards = document.getElementById(
  "compliance-insights-forecast-cards"
);
...
const complianceInsightsPreviewCount = document.getElementById("compliance-insights-preview-count");
const complianceInsightsPreviewMeta = document.getElementById("compliance-insights-preview-meta");
const complianceInsightsPreviewDescription = document.getElementById(
...
const workspacePreviewReminderBtn = document.getElementById("workspace-preview-reminder-btn");
const reminderPreviewModal = document.getElementById("reminder-preview-modal");
const reminderPreviewModalCloseBtn = document.getElementById("reminder-preview-modal-close-btn");
const reminderPreviewCloseBtn = document.getElementById("reminder-preview-close-btn");
const reminderPreviewModalRecordLabel = document.getElementById("reminder-preview-modal-record-label");
const reminderPreviewMissingRecipient = document.getElementById("reminder-preview-missing-recipient");
const reminderPreviewRecipientEmail = document.getElementById("reminder-preview-recipient-email");
const reminderPreviewManagerRow = document.getElementById("reminder-preview-manager-row");
const reminderPreviewManagerEmail = document.getElementById("reminder-preview-manager-email");
const reminderPreviewReminderType = document.getElementById("reminder-preview-reminder-type");
const reminderPreviewSubject = document.getElementById("reminder-preview-subject");
const reminderPreviewBody = document.getElementById("reminder-preview-body");
const reminderPreviewMessage = document.getElementById("reminder-preview-message");

/** @type {{ preview: import("./js/app/reminders/reminder-templates.js").ReminderTemplatePreview; personName: string; recordLabel: string } | null} */
let reminderPreviewContext = null;
...
function renderComplianceInsights() {
  ...
  if (complianceInsightsOperationalSummary) {
    ...
    if (summary.title) {
      complianceInsightsOperationalSummary.title = summary.title;
    } else {
      complianceInsightsOperationalSummary.removeAttribute("title");
    }

    if (summary.ariaLabel) {
      complianceInsightsOperationalSummary.setAttribute("aria-label", summary.ariaLabel);
    } else {
      complianceInsightsOperationalSummary.removeAttribute("aria-label");
    }
  }

  if (complianceInsightsOperationalMissingCount) {
    complianceInsightsOperationalMissingCount.textContent =
      insights.operationalHealth?.recordsMissingReminderActivity ?? 0;
  }
...
function updateComplianceInsightsSectionEmptyStates(insights) {
  const riskTotal =
    (insights.risk?.expiredRecords ?? 0) +
    (insights.risk?.missingEvidenceRecords ?? 0) +
    (insights.risk?.staleEvidenceRecords ?? 0) +
    (insights.risk?.overdueActions ?? 0) +
    (insights.risk?.expiredWithActiveActions ?? 0);
  const hasRisks = riskTotal > 0;

  if (complianceInsightsRiskEmpty) {
    complianceInsightsRiskEmpty.classList.toggle("hidden", hasRisks);
  }

  if (complianceInsightsRiskStrip) {
    complianceInsightsRiskStrip.classList.toggle("hidden", !hasRisks);
  }

  const evidenceGapTotal =
    (insights.evidenceGaps?.byTier?.critical ?? 0) +
    (insights.evidenceGaps?.byTier?.high ?? 0) +
    (insights.evidenceGaps?.byTier?.stale ?? 0);
  const hasEvidenceGaps = evidenceGapTotal > 0;

  if (complianceInsightsEvidenceGapsEmpty) {
    complianceInsightsEvidenceGapsEmpty.classList.toggle("hidden", hasEvidenceGaps);
  }

  if (complianceInsightsEvidenceGapsStrip) {
    complianceInsightsEvidenceGapsStrip.classList.toggle("hidden", !hasEvidenceGaps);
  }

  const forecastTotal =
    (insights.forecast?.expiringThisMonth ?? 0) +
    (insights.forecast?.expiringNextMonth ?? 0) +
    (insights.forecast?.expiringWithin30Days ?? 0) +
    (insights.forecast?.expiringWithin90Days ?? 0);
  const hasForecast = forecastTotal > 0;

  if (complianceInsightsForecastEmpty) {
    complianceInsightsForecastEmpty.classList.toggle("hidden", hasForecast);
  }

  if (complianceInsightsForecastCards) {
    complianceInsightsForecastCards.classList.toggle("hidden", !hasForecast);
  }

  const missingFollowUp = insights.operationalHealth?.recordsMissingReminderActivity ?? 0;
  const hasOperationalIssues = missingFollowUp > 0;

  if (complianceInsightsOperationalEmpty) {
    complianceInsightsOperationalEmpty.classList.toggle("hidden", hasOperationalIssues);
  }

  const operationalMissingBtn = document.getElementById(
    "compliance-insights-operational-missing-btn"
  );
...
function buildComplianceInsightDrilldownRecordRow(row, drilldownType, ctx) {
  if (drilldownType === COMPLIANCE_INSIGHT_DRILLDOWN_TYPES.MISSING_REMINDER_ACTIVITY) {
    const previewRow = mapMissingReminderActivityPreviewRow(row, ctx);
...
function buildComplianceInsightDrilldownReport(drilldownType) {
  ...
  if (isActionLevelDrilldown(drilldownType)) {
    ...
    tableRows = matchedRows.map((row) =>
      buildComplianceInsightDrilldownRecordRow(row, drilldownType, ctx)
    );
  }
...
function renderComplianceInsightDrilldownPreview(report) {
  ...
  complianceInsightsPreviewTitle.textContent = `Preview: ${report.title}`;

  const countLabel =
    report.totalCount === 1
      ? `1 ${report.itemLabel.replace(/s$/, "").toLowerCase()}`
      : `${report.totalCount} ${report.itemLabel.toLowerCase()}`;

  if (complianceInsightsPreviewCount) {
    complianceInsightsPreviewCount.textContent = countLabel;
  }

  complianceInsightsPreviewMeta.textContent = `Generated ${report.generatedDisplay}. Showing ${countLabel}.`;
...
function clearComplianceInsightDrilldownPreview() {
  ...
  if (complianceInsightsPreviewCount) {
    complianceInsightsPreviewCount.textContent = "";
  }
...
function renderReminderPreviewDashboardCards() {
  ...
  if (reminderPreviewDashboardExpiredCount) {
    reminderPreviewDashboardExpiredCount.textContent =
      metrics[REMINDER_PREVIEW_DASHBOARD_TYPES.EXPIRED];
  }

  if (reminderPreviewDashboardTotalCount) {
    reminderPreviewDashboardTotalCount.textContent =
      metrics[REMINDER_PREVIEW_DASHBOARD_TYPES.TOTAL];
  }
}
...
function renderReminderDigestPreview(queue) {
  if (
    !reminderDigestPreview ||
    !reminderDigestPreviewSafetyNote ||
    !reminderDigestPreviewTotalCount ||
    !reminderDigestPreviewMissingEmailCount ||
    !reminderDigestPreviewExpiredCount ||
    !reminderDigestPreview30Count ||
    !reminderDigestPreview14Count ||
    !reminderDigestPreview7Count ||
    !reminderDigestPreviewSubject ||
    !reminderDigestPreviewBody
  ) {
    return;
  }
...
function handleReminderQueuePreviewTableClick(event) {
  ...
  if (copyButton) {
    const rowKey = copyButton.dataset.queueRowKey;

    if (rowKey) {
      void copyReminderQueueTemplate(rowKey);
    }
...
function renderReminderQueuePreview() {
  if (
    !reminderQueuePreviewSection ||
    !reminderQueuePreviewTotalCount ||
    !reminderQueuePreviewMissingEmailCount ||
    !reminderQueuePreviewExpiredCount ||
    !reminderQueuePreview30Count ||
    !reminderQueuePreview14Count ||
    !reminderQueuePreview7Count ||
    !reminderQueuePreviewEmpty ||
    !reminderQueuePreviewTableWrapper ||
    !reminderQueuePreviewTableHead ||
    !reminderQueuePreviewTableBody
  ) {
    return;
  }
  ...
  if (reminderQueuePreviewMeta) {
    const scanDateLabel =
      queue.asOfDate && !Number.isNaN(parseDateAtMidnight(queue.asOfDate).getTime())
        ? formatDate(queue.asOfDate)
        : "today";
    reminderQueuePreviewMeta.textContent = `Scan as of ${scanDateLabel} · ${queue.summary.total} queued`;
  }
  ...
  reminderQueuePreviewTableBody.innerHTML = previewRows
    .map((row, index) => {
      ...
      return `
        ...
        ${
          isExpanded
            ? `<tr class="reminder-queue-template-preview-detail-row" data-queue-row-key="${escapeHtml(rowKey)}">
...
function renderReminderPreviewDashboardPreview(report) {
  if (
    !reminderPreviewDashboardPreview ||
    !reminderPreviewDashboardPreviewTitle ||
    !reminderPreviewDashboardPreviewMeta ||
    !reminderPreviewDashboardTableHead ||
    !reminderPreviewDashboardTableBody
  ) {
    return;
  }
  ...
  const countLabel = `${report.totalCount} ${report.itemLabel.toLowerCase()}`;
  reminderPreviewDashboardPreviewMeta.textContent = `Generated: ${report.generatedDisplay} · ${countLabel}`;
  ...
  if (report.tableRows.length === 0) {
    ...
    reminderPreviewDashboardTableBody.innerHTML = report.tableRows
      .map(
        (row) => `
...
function exportReminderPreviewPack() {
  ...
  const filename =
    currentReminderPreviewDashboard.filename ||
    buildReminderPreviewPackFilename(currentReminderPreviewDashboard.type);
...
function updateReminderPreviewDashboardCardActiveState() {
  reminderPreviewDashboardCards.forEach((card) => {
    card.classList.toggle(
      "active",
      Boolean(
        currentReminderPreviewDashboard &&
          card.dataset.reminderPreviewDashboard === currentReminderPreviewDashboard.type
      )
    );
  });
}
...
function refreshActiveReminderPreviewDashboardPreview() {
  if (
    !currentReminderPreviewDashboard?.type ||
    !reminderPreviewDashboardPreview ||
    reminderPreviewDashboardPreview.classList.contains("hidden")
  ) {
    return;
  }
...
function renderAutomationRunAudit() {
  if (
    !automationRunAuditSection ||
    !automationRunAuditLocalHint ||
    !automationRunAuditError ||
    !automationRunAuditEmpty ||
    !automationRunAuditTableWrapper ||
    !automationRunAuditTableHead ||
    !automationRunAuditTableBody
  ) {
    return;
  }
  ...
  if (automationRunAuditLoadState === "error") {
    automationRunAuditError.textContent =
      automationRunAuditLoadError ||
      "Could not load automation runs. Check your connection and try signing in again.";
  ...
  automationRunAuditTableBody.innerHTML = auditRows
    .map((row) => {
      ...
      return `
          ...
          ${
            isExpanded
              ? `<tr class="automation-run-audit-detail-row" data-run-id="${escapeHtml(row.id)}">
...
function renderEmailAutomationVisibility() {
  if (
    !emailAutomationVisibilitySection ||
    !emailAutomationVisibilityLocalHint ||
    !emailAutomationVisibilityError ||
    !emailAutomationVisibilityEmpty ||
    !emailAutomationVisibilityRunsWrapper ||
    !emailAutomationVisibilityRunsHead ||
    !emailAutomationVisibilityRunsBody ||
    !emailAutomationVisibilityLogsPanel ||
    !emailAutomationVisibilityLogsTitle ||
    !emailAutomationVisibilityLogsError ||
    !emailAutomationVisibilityLogsEmpty ||
    !emailAutomationVisibilityLogsWrapper ||
    !emailAutomationVisibilityLogsHead ||
  ...
  if (emailAutomationVisibilityLoadState === "error") {
    emailAutomationVisibilityError.textContent =
  ...
  emailAutomationVisibilityRunsBody.innerHTML = emailAutomationRuns
    .map((run) => {
  ...
  if (emailAutomationDeliveryLogsLoadState === "error") {
    emailAutomationVisibilityLogsError.textContent =
      emailAutomationDeliveryLogsLoadError ||
      "Could not load delivery logs for this automation run.";
  ...
  emailAutomationVisibilityLogsBody.innerHTML = logRows
    .map(
      (row) => `
...
async function loadEmailAutomationVisibility() {
  ...
  if (
    selectedEmailAutomationRunId &&
    !emailAutomationRuns.some((run) => run.automationRunId === selectedEmailAutomationRunId)
  ) {
    selectedEmailAutomationRunId = "";
    emailAutomationDeliveryLogs = [];
    emailAutomationDeliveryLogsLoadState = "idle";
