...
/** @returns {boolean} */
export function canAddComplianceRecord() {
  if (!isCloudMode()) {
    return canMutateData();
  }
...
/** @returns {boolean} */
export function canEditComplianceRecord() {
  if (!isCloudMode()) {
    return canMutateData();
  }
...
/** @returns {boolean} */
export function canUpdateComplianceRecordNotes() {
  if (!isCloudMode()) {
    return canMutateData();
  }
...
/** @returns {boolean} */
export function canArchiveComplianceRecord() {
  if (!isCloudMode()) {
    return canMutateData();
  }
