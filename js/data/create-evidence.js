/**
 * Create evidence mapping and validation (local + cloud RPC).
 */
 ...
 * @returns {string}
 */
export function buildEvidenceAddedHistoryDescription(documentType) {
  return `Evidence added: ${documentType}.`;
}
 ...
 */
export function validateCreateEvidenceInput(input) {
  const errors = [];
 ...
 * }}
 */
export function mapCreateEvidenceToRpc(input) {
  const rpcArgs = {
